...
function library:Window(Info)
    ...
    -- Create topbar (draggable header)
    ...
    -- Animate rainbow underline
    task.spawn(function()
        local hue = 0
        while underline and underline.Parent do
            hue = (hue + 0.01) % 1
            underline.BackgroundColor3 = Color3.fromHSV(hue, 1, 1)
            task.wait(0.02)
        end
    end)
